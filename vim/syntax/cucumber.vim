...
" vi':se':name.'ButRegion'
" endfunction
"
" syn match   cucumberComment  "\%(^\s*\)\@<=#.*"
"
" exe 'syn match cucumberFeature "\%(^\s*\)\@<='.s:pattern('feature').':"'
" exe 'syn match cucumberBackground
" "\%(^\s*\)\@<='.s:pattern('background').':"'
" exe 'syn match cucumberScenario "\%(^\s*\)\@<='.s:pattern('scenario').':"'
" exe 'syn match cucumberScenarioOutline
" "\%(^\s*\)\@<='.s:pattern('scenario_outline').':"'
" exe 'syn match cucumberExamples "\%(^\s*\)\@<='.s:pattern('examples').':"
" nextgroup=cucumberExampleTable skipnl skipwhite'
"
" syn match   cucumberPlaceholder   "<[^<>]*>" contained
" containedin=@cucumberStepRegions
" syn match   cucumberExampleTable  "\%(^\s*\)\@<=|.*"
" contains\)\@<='.s:pattern('scenario').':"'
" exe 'syn match cucumberScenarioOutline
" "\%(^\s*\)\@<='.s:pattern('scenario_outline').':"'
" exe 'syn match cucumberExamples "\%(^\s*\)\@<='.s:pattern('examples').':"
" nextgroup=cucumberExampleTable skipnl skipwhite'
...
" "\%(^\s*\)\@<='.s:pattern('scenario_outline').':"'
" exe 'syn match cucumberExamples "\%(^\s*\)\@<='.s:pattern('examples').':"
" nextgroup=cucumberExampleTaDelimiter         Delimiter
